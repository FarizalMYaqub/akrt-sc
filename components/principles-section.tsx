  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <div className="mt-4 text-base md:text-lg text-muted-foreground max-w-2xl">
          Build{' '}
          <FlipWords words={["better", "faster", "modern", "beautiful"]} duration={2500} className="text-accent font-semibold" />
          {' '}products and interfaces that scale — design systems first, pixels second.
        </div>
      </div>
